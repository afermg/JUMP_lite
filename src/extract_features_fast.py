...
Usage:
    ...
    python src/extract_features_fast.py --input /work/datasets/aliby_output --output ./output

    # Process specific model only
    python src/extract_features_fast.py --input /work/datasets/aliby_output --model cp_measure --output ./output

    # Control parallelism (default: all cores)
    python src/extract_features_fast.py --input /work/datasets/aliby_output --output ./output --n-jobs 4
"""
...
Examples:
  ...
  python src/extract_features_fast.py --input /work/datasets/aliby_output --model cp_measure --output ./output --n-jobs 4

  # Sequential mode (like original extract_features.py)
  python src/extract_features_fast.py --input /work/datasets/aliby_output --output ./output --n-jobs 1
        """,
    )
    parser.add_argument(
        "--input",
