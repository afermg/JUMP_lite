...
- Validate all archived aggregate points, pin the observed PA query counts (1,280 for learned families; 1,263--1,266 for cp_measure), and exactly align 306 PA broad-sample clusters and 201 PC target clusters across all 15 family/codec variants.
